                    ...
                    <div className="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full px-4 py-2.5 border rounded-xl outline-none transition-all font-medium bg-white ${
                                    hasError('branch_id') ? 'border-red-300 ring-4 ring-red-100' : 'border-gray-200 focus:ring-4 focus:ring-eco-500/10 focus:border-eco-500'
                                }`}
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-9 pr-4 py-2.5 border rounded-xl outline-none transition-all font-bold ${
                                            hasError('physical_stock') ? 'border-red-300 ring-4 ring-red-100' : 'border-gray-200 focus:ring-4 focus:ring-eco-500/10 focus:border-eco-500'
                                        }`}
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-9 pr-4 py-2.5 border rounded-xl outline-none transition-all font-bold ${
                                            hasError('marketing_stock') ? 'border-red-300 ring-4 ring-red-100' : 'border-gray-200 focus:ring-4 focus:ring-eco-500/10 focus:border-eco-500'
                                        }`}
                                    />
                                </div>
                            </div>
