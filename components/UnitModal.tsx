          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 sm:col-span-1">
                ...
                <input
                    ...
                    className={`w-full px-4 py-2 border rounded-lg outline-none transition-all ${
                        hasError('name') ? 'border-red-500 ring-2 ring-red-100 focus:border-red-600' : 'border-gray-300 focus:ring-2 focus:ring-eco-500 focus:border-eco-500'
                    }`}
            ...
            <div className="col-span-2 sm:col-span-1">
                ...
                <input
                    ...
                    type="text"
                    required
                    className={`w-full px-4 py-2 border rounded-lg outline-none transition-all uppercase font-mono ${
                        hasError('code') ? 'border-red-500 ring-2 ring-red-100 focus:border-red-600' : 'border-gray-300 focus:ring-2 focus:ring-eco-500 focus:border-eco-500'
                    }`}
                    placeholder="e.g., KG"
                    value={formData.code}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
                ...
                <input
                    ...
                    required
                    className={`w-full px-4 py-2 border rounded-lg outline-none transition-all ${
                        hasError('abbreviation') ? 'border-red-500 ring-2 ring-red-100 focus:border-red-600' : 'border-gray-300 focus:ring-2 focus:ring-eco-500 focus:border-eco-500'
                    }`}
                    placeholder="e.g., kg"
            ...
            <div>
                ...
                <input
                    ...
                    step="0.01"
                    className={`w-full px-4 py-2 border rounded-lg outline-none transition-all ${
                        hasError('quantity') ? 'border-red-500 ring-2 ring-red-100 focus:border-red-600' : 'border-gray-300 focus:ring-2 focus:ring-eco-500 focus:border-eco-500'
                    }`}
