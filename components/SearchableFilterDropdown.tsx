  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`w-full flex items-center justify-between ${compact ? 'px-2 py-3 rounded-lg text-xs' : 'px-4 py-2.5 rounded-xl text-sm'} border outline-none transition-all font-medium text-left bg-white shadow-sm ${error
