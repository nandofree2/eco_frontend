        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl border border-gray-100">
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${adjustment.adjustment_type === AdjustmentType.In ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'
                  }`}>
                ...
                <div>
                  ...
                  <h3 className={`text-base font-black leading-tight ${adjustment.adjustment_type === AdjustmentType.In ? 'text-green-700' : 'text-red-700'
                    }`}>
