        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              required
              className={`w-full px-4 py-2 border rounded-xl outline-none transition-all font-mono ${hasError('sku') ? 'border-red-500 ring-4 ring-red-100' : 'border-gray-200 focus:ring-4 focus:ring-eco-500/10 focus:border-eco-500'
                }`}
              placeholder="e.g. ORG"
              value={formData.sku}
