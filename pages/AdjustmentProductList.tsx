...
import { 
  ...
  XCircle, RefreshCw, ChevronLeft, ChevronRight, Filter, Building2, X
} from 'lucide-react';
import AdjustmentProductModal from '../components/AdjustmentProductModal';
import AdjustmentProductDetailModal from '../components/AdjustmentProductDetailModal';
...
const AdjustmentProductList: React.FC = () => {
                            ...
                            <tr key={adj.id} className="group hover:bg-eco-50/20 transition-all duration-200">
                                ...
                                <td className="px-4 py-2">
                                    <span className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold ${
                                        adj.adjustment_type === AdjustmentType.In 
                                ...
                                <td className="px-4 py-2">
                                    <span className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold ${
                                        adj.approval_status === ApprovalStatus.Approved ? 'bg-green-100 text-green-700' :
