                                    ...
                                    <tr key={resource} className="hover:bg-eco-50/20 transition-colors">
                                        ...
                                        {ACTIONS.map(action => (
                                            <td key={action} className="px-3 py-5 text-center">
                                                <button
                                                    ...
                                                    className={`w-7 h-7 rounded-xl flex items-center justify-center mx-auto transition-all border-2 ${
                                        ...
                                        <td className="px-6 py-5 text-center">
                                            <button
                                                ...
                                                className={`text-[10px] font-extrabold px-3 py-1.5 rounded-full transition-all tracking-wider ${
                                                    isFull 
