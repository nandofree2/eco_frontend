...
const Profile: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      />
      {toast && (
        <div className={`fixed top-20 right-6 z-[200] p-4 rounded-xl shadow-2xl border flex items-start gap-3 animate-in slide-in-from-right ${toast.type === 'success' ? 'bg-green-50 border-green-200 text-green-800' : 'bg-red-50 border-red-200 text-red-800'
          }`}>
